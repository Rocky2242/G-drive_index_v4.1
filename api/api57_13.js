...
function append_files_to_list(path, files) {
    ...
    var LstPage = Math.ceil(itemTotal / 16);
    console.log("Lst page is",LstPage);

    var files =  files.splice((pgno-1)*16, 16);
	console.log(files);
	for (i in files) {
		var item = files[i];
  ...
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link" href="?p=${pgno-1}">?p=${pgno-1}</a></li>
    <li class="page-item"><a class="page-link" href="?p=${pgno}">?p=${pgno}</a></li>
    <li class="page-item"><a class="page-link" href="?p=${pgno+1}">?p=${pgno+1}</a></li>
    <li class="page-item">
    ...
    <li class="page-item"><a class="page-link" href="?p=${LstPage}">?p=${LstPage}</a></li>
