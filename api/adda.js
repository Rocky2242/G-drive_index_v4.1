...
function init() {
	...
	var html = `<header class="short-header"><div id="nav"></div></header>
         <div id="top">
           <div id="content"></div>
         <div>
  `;
...
function nav(path) {
	...
	var search_bar = `<form role="search" method="get" class="search-form" action="/${cur}:search">
					<label>
						<span class="hide-content">Search for:</span>
						<input type="search" class="search-field" placeholder="Type Your Keywords" value="${search_text}" name="q" title="Search for:" autocomplete="off">
					</label>
					<input type="submit" class="search-submit" value="Search" required="">
				</form>
				   <span id="close-search" class="close-btn">Close</span>
			</div>
			    <div class="triggers">
...
<script type="application/javascript" src="https://a.realsrv.com/ads.js"></script>
              <iframe src="//syndication.realsrv.com/ads-iframe-display.php?idzone=4145184&output=noscript" width="300" height="250" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"></iframe>
<script type="application/javascript" src="//a.realsrv.com/ads.js"></script>

    </div>
    <script type="application/javascript">
    var ad_idzone = "4145184",
    ad_width = "300",
    ad_height = "250"
</script>
<script type="application/javascript" src="https://a.realsrv.com/ads.js"></script>
	...
	for (i in files) {
		...
		if (item['mimeType'] == 'application/vnd.google-apps.folder') {
          ...
          $("img").addClass("img-fluid")
            ...
            var res = item['thumbnailLink'].replace("=s220","=s420");
