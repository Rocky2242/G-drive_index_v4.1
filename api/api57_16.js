...
function append_files_to_list(path, files) {
 ...
 <nav aria-label="Page navigation example">
  <ul class="pagination">
    <li class="page-item"><a class="page-link" href="?p=${+pgno - 1}">Previous</a></li>
    ...
    <li class="page-item"><a class="page-link" href="?p=${+pgno - 1}">${+pgno - 1}</a></li>
    <li class="page-item"><a class="page-link" href="?p=${pgno}">${pgno}</a></li>
    <li class="page-item"><a class="page-link" href="?p=${+pgno + 1}">${+pgno + 1}</a></li>
    <li class="page-item">
    ...
    <li class="page-item"><a class="page-link" href="?p=${LstPage}">${LstPage}</a></li>
    <li class="page-item"><a class="page-link" href="?p=${+pgno + 1}">Next</a></li>
  </ul>
 </nav>
			`;
	/*let targetObj = {};
