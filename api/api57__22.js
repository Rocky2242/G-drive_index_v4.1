...
function append_files_to_list(path, files) {
  ...
  html += `<div class="container"><br><br><nav aria-label="Page navigation example"><ul class="pagination">`;
  if (pgno > 1) {
